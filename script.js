...
function changeLanguage() {
    ...
    if (languageBtn.textContent === "RU") {
        ...
        agreeBtn.innerHTML ="I confirm that I have read and<br>understood these policies"
        textBanner.innerHTML = 'To improve the performance of the site and make it more convenient for users, we use cookies (small text files).<br>By continuing work with the site, you are agreeing to use of cookies. You can always disable them in your browser settings.<br>Please read our <a href="public/Политика%20по%20использованию%20cookies%20(01.03.24).pdf" download="Политика использования cookie" target="_blank">cookie policy</a> first. We take the protection of your personal data seriously.<br>If you want to learn more about how we process it, please read our <a href="public/Политика%20конфиденциальности%20(01.03.24).pdf" download="Политика конфиденциальности" target="_blank">privacy policy</a>.';      
    } else {
